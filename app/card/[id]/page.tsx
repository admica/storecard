    ...
    return (
        <div className="flex min-h-screen flex-col bg-background pb-safe">
            <header className="absolute top-0 left-0 right-0 z-10 p-4 flex justify-between items-center">
                <Link
                    href="/dashboard"
                    className="h-10 w-10 rounded-full glass flex items-center justify-center text-primary hover:bg-white/80 transition-colors"
                >
                ...
                <div className="flex space-x-2">
                    ...
                    <form action={deleteCard.bind(null, card.id)}>
                        <button
                            type="submit"
                            className="h-10 w-10 rounded-full glass flex items-center justify-center text-red-600 hover:bg-red-50 transition-colors"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
